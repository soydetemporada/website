...
A pesar de contar con fuentes oficiales para recopilar estos datos, es necesario un esfuerzo importante a la hora de descargar y organizar la información, los principales problemas encontrados son:
 Markup :	* Falta de actualización, los datos tardan en consolidarse, y hay que trabajar con datos provisionales si se quieren estadísticas actuales. Para este proyecto se han usado datos definitivos del año 2015 para elaborar las estadísticas.
